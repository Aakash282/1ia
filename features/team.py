				...
				if spread_team == this_team:
					...
					if score_diff + spread > 0:
						if w == 0:
							...
							record_vs_spread[w] = (record_vs_spread[w - 1] + 1) / float(season[this_team]['week year'][w])
					...
					# If this_team lost against the spread
						...
						if w == 0:
							...
							record_vs_spread[w] = record_vs_spread[w - 1] / float(season[this_team]['week year'][w])
