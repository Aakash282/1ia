...
def feature_set(year):
    ...
    for idx, row in league_data.iterrows():
        ...
        feature_lst = temp_features['away'].values() + temp_features['home'].values() + [score_diff] + temp_features['game'].values() + [week_year]
        outputs.append(feature_lst)
    #print default_timer() - iter_start
